...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '0.0.0.0', '10.0.2.2', '172.20.10.4']
...
CORS_ALLOW_ALL_ORIGINS = True  # Для разработки; для продакшена используйте CORS_ALLOWED_ORIGINS
